...
public class StellarisLocalizationIconNameImpl extends ASTWrapperPsiElement implements StellarisLocalizationIconName {

  public StellarisLocalizationIconNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StellarisLocalizationVisitor visitor) {
    visitor.visitIconName(this);
  }
