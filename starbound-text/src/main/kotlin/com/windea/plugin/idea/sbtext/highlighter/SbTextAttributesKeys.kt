...
object SbTextAttributesKeys {
	...
	@JvmField val COLOR_KEYS = StarboundColor.map.mapValues { (_, value) ->
		TextAttributesKey.createTextAttributesKey(
			"${message("sbText.syntax.color")}_${value.key}",
			TEXT_KEY.defaultAttributes.clone().apply {
	...
	@JvmField
	val INVALID_ESCAPE_KEY = createTextAttributesKey(message("sbText.syntax.invalidEscape"), INVALID_STRING_ESCAPE)
