...
class PdxLocalisationParserDefinition : ParserDefinition {
	companion object {
		...
		val FILE = PdxLocalisationStubElementTypes.FILE
	}

	override fun createLexer(project: Project?) = PdxLocalisationLexerAdapter()
	...
	override fun createParser(project: Project?) = PdxLocalisationParser()
	
	override fun getFileNodeType() = FILE

	override fun createFile(viewProvider: FileViewProvider) = PdxLocalisationFile(viewProvider)
	...
	override fun createElement(node: ASTNode) = PdxLocalisationTypes.Factory.createElement(node)
}
