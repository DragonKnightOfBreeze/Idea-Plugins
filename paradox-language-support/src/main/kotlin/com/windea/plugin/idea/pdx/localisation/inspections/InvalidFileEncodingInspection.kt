...
class InvalidFileEncodingInspection : LocalInspectionTool() {
	override fun checkFile(file: PsiFile, manager: InspectionManager, isOnTheFly: Boolean): Array<out ProblemDescriptor?>? {
		...
		if(!isValid){
			...
			val description = message("pdx.localisation.inspection.invalidFileEncoding.description", charset,bomText)
	...
	private class ChangeFileEncoding(
		...
		override fun getText(): String {
			return message("pdx.localisation.quickFix.changeFileEncoding")
		}
