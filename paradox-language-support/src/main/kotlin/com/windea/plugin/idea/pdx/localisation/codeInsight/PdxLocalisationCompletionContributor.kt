...
package com.windea.plugin.idea.pdx.localisation.codeInsight
...
class PdxLocalisationCompletionContributor : CompletionContributor() {
	class LocaleCompletionProvider : CompletionProvider<CompletionParameters>() {
		private val lookupElements = PdxLocale.values.map{value->
