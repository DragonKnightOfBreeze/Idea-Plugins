...
class ParadoxLocalisationSyntaxHighlighter : SyntaxHighlighterBase() {
	companion object {
		...
		private val SERIAL_NUMBER_ID_KEYS = arrayOf(ParadoxLocalisationAttributesKeys.SERIAL_NUMBER_ID_KEY)
		private val COLOR_ID_KEYS = arrayOf(ParadoxLocalisationAttributesKeys.COLOR_ID_KEY)
