...
//https://pdx.paradoxwikis.com/
//https://qunxing.huijiwiki.com/wiki/%E6%96%87%E4%BB%B6:Xxx.png
//https://pdx.paradoxwikis.com/File:Xxx.png

/**
 * 图标地址的解析器
 *
 * 基于名称以及qunxing.huijiwiki.com和pdx.paradoxwikis.com上的文件解析图标地址。
 */
object PdxLocalisationIconUrlResolver {
	...
	private fun paradoxwikisPngUrl(name:String): String {
		...
		return "https://pdx.paradoxwikis.com/File:$fqName.png"
	}
}
