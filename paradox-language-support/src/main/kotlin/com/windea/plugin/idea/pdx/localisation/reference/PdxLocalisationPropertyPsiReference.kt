...
package com.windea.plugin.idea.pdx.localisation.reference
...
class PdxLocalisationPropertyPsiReference(
	element: PdxLocalisationPropertyReference,
	rangeInElement: TextRange
) : PsiReferenceBase<PdxLocalisationPropertyReference>(element, rangeInElement), PsiPolyVariantReference {
	private val name = rangeInElement.substring(element.text)
	private val locale = (element.containingFile as? PdxLocalisationFile)?.locale?.pdxLocale
